...
class SingleStringMathTex(SVGMobject):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._async_tex_future = None

        from manim.utils.tex_file_writing import _svg_memory_cache, tex_hash
        cache_key = tex_hash(self._get_modified_expression(tex_string))
        if cache_key in _svg_memory_cache:
            file_name = _svg_memory_cache[cache_key]
        else:
