...
class NumberLine(Line):
    ...
    def __init__(
        ...
        label_constructor: type[MathTex] = None,
        ...
        **kwargs: Any,
        ...
        self.label_constructor = label_constructor if label_constructor is not None else Text
    ...
    def add_labels(
        ...
        for x, label in dict_values.items():
            ...
            if isinstance(label, str) and label_constructor is MathTex:
                label = Tex(label)
            elif isinstance(label, str) and label_constructor is Text:
                label = Text(label)
            else:
