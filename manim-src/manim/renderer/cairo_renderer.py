...
class CairoRenderer:
    ...
    def update_frame(  # TODO Description in Docstring
        ...
        **kwargs
        ...
        if self.frame_callback is not None:
            ...
            if self._frame_counter % self._frame_rate == 0:
                try:
                    self.frame_callback(self.get_frame())
                except Exception:
                    pass
    ...
    def _push_frame(self, frame: PixelArray) -> None:
        # frame_callback 已在 update_frame() 中调用，此处不再重复
        pass
